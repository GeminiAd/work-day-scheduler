...
function initializeTimeBlocks() {
    ...
    for (var i = 0; i < hourMoments.length-1; i++) {
        ...
        var hour = $("<label>");
        hour.addClass("hour p-3 text-right col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1");
        ...
        textArea.addClass("col-8 col-sm-8 col-md-10 col-lg-10 col-xl-10 text-dark");
        ...
        saveButton.addClass("saveBtn col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1");
